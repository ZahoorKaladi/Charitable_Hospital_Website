...
import galleryData from '../data/galleryData'; // Static data
...
  useEffect(() => {
    // Commented out the fetch call to the live API for local static data
    /*
...
      });
    */
    // We will now load the data from your static file
    setTimeout(() => {
